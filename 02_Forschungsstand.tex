...
der Umstellung entfernt werden.
...
% --- Eigene Grafik zur Einordnung (nachgebaut, nicht übernommen) ---
\input{Grafiken/s4hana architektur}
...
Deutung bildet den Ausgangspunkt der vorliegenden Arbeit und wird im Stand der
Forschung vertieft betrachtet.
...
Die in diesem Abschnitt eingeführten Materialien
bilden damit den Gegenstand der Untersuchung; im folgenden Abschnitt werden die
Verfahren dargelegt, mit denen diese Materialien erschlossen, interpretiert sowie
gegen den Systemzustand abgesichert werden.
